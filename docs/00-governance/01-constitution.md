...
El frontend conserva Angular 21 standalone, PrimeNG, signals y separación API/store. El backend conserva Rust, Axum, SQLx y separación routes/handlers/services/DTO/models/storage. Una excepción requiere una decisión explícita en `04-research.md`.
