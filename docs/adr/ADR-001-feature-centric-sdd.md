...
Mantener constitución, producto, ADR y manuales como artefactos globales. Mantener todos los artefactos evolutivos dentro de `docs/features/NNN-nombre-feature/`.
